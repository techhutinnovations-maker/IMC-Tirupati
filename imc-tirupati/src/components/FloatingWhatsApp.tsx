...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-4">
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 px-4 py-2 rounded-2xl shadow-2xl backdrop-blur-xl"
          >
      ...
      <motion.a
        ...
        animate={{
          boxShadow: [
            ...
            "0px 0px 0px 15px rgba(34, 197, 94, 0.1)",
            "0px 0px 0px 0px rgba(34, 197, 94, 0)",
          ],
        }}
        transition={{
      ...
      >
        {/* Custom WhatsApp Icon SVG for better brand accuracy */}
        <svg 
          viewBox="0 0 24 24" 
          width="32" 
          height="32" 
